class Invoice < ActiveRecord::Base
  ...
  validates :user, presence: true, if: lambda { |i| i.current_step == 'confirmation' }
  ...
  validate :choose_xor_sale_project, if: lambda { |i| i.current_step == 'sale_project' }
  ...
  def steps
    %w[sale_project invoice confirmation]
  end
