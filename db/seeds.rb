...
if Apartment::Tenant.current == 'public'
  ...
  Event.create([{ title: 'Title 1', start: 2.days.ago, end: Date.yesterday, color: '#7DA40D' },
    { title: 'Title 1', start: DateTime.now - 2, end: (DateTime.now - 2) + 6.hours, color: '#faca0a' },
    { title: 'Title 1', start: Date.today, end: Date.tomorrow, color: '#7DA40D' },
    { title: 'Title 1', start: DateTime.now + 4, end: (DateTime.now + 4) + 4.hours, color: '#be0a0a' },
    { title: 'Title 1', start: Date.today + 6, end: Date.today + 7, color: '#be0a0a' },
    { title: 'Title 1', start: DateTime.now + 2, end: (DateTime.now + 2) + 3.hours, color: '#199CD5' }])
end
